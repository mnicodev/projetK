...
<table class=\"views-table views-view-table cols-10 sticky-enabled table table-bordered  responsive table-dark\">
";
        // line 4
...
{% for key,line in pub %}
<tr>
<td colspan='4' class=\"\">du {{ key|replace({\"_\":\" au \"}) }}</td>
</tr>

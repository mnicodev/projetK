...
";
        ...
        foreach ($context['_seq'] as $context["key"] => $context["line"]) {
            // line 4
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, twig_split_filter($this->env, $this->sandbox->ensureToStringAllowed($context["key"]), "-"), "html", null, true);
            echo "
    ";
            // line 5
            $context['_parent'] = $context;
    ...
    ";
            ...
            // line 8
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute(($context["pub"] ?? null), $context["key"], [], "array"), "format", [])), "html", null, true);
            echo "
";
        }
        $_parent = $context['_parent'];
    ...
    {
        return array (  81 => 8,  74 => 6,  70 => 5,  66 => 4,  62 => 3,  58 => 1,);
    }

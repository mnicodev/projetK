...
";
        // line 2
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute(($context["pub"] ?? null), 0, [], "array"), "title", [])), "html", null, true);
        echo "
";
        // line 3
...
";
            // line 5
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($context["item"], "nom", [])), "html", null, true);
            echo "
";
        }
    ...
    {
        return array (  73 => 5,  69 => 4,  65 => 3,  61 => 2,  58 => 1,);
    }

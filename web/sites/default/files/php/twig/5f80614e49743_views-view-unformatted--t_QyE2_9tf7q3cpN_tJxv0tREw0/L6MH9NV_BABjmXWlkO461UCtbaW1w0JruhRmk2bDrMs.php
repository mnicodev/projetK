...
($context["default_row_class"] ?? null)) ? ("views-row") : (""))];
            ...
            if ((($context["cpt"] ?? null) == 2)) {
                ...
                echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["pub"] ?? null)), "html", null, true);
                echo "<a href=\"";
...
{% for row in rows %}
  ...
  %}
  {% if cpt == 2 %}
  <div>{{ cpt_pub }}{{ pub }}<a href=\"{{ pub.cpt_pub.url }}\" target=\"blank\"><img src=\"{{ pub.cpt_pub.img }}\" title=\"{{ pub.cpt_pub.title }}\" /></a></div>
  {% set cpt = 0 %}

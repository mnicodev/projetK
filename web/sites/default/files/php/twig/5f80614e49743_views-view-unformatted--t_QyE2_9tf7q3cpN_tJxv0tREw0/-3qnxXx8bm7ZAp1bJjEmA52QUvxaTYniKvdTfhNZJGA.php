...
($context["default_row_class"] ?? null)) ? ("views-row") : (""))];
            ...
            if ((($context["cpt"] ?? null) == 2)) {
                ...
                echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute(($context["pub"] ?? null), 0, []), "title", [])), "html", null, true);
                echo "<a href=\"";
...
";
    ...
    {
        return array (  116 => 39,  114 => 38,  111 => 37,  108 => 36,  105 => 35,  102 => 34,  99 => 33,  96 => 32,  94 => 31,  82 => 30,  79 => 29,  77 => 26,  76 => 25,  74 => 24,  70 => 23,  68 => 22,  66 => 21,  60 => 19,  58 => 18,);
    }
...
{% for row in rows %}
  ...
  %}
  {% if cpt == 2 %}
  <div>{{ cpt_pub }}{{ pub.0.title }}<a href=\"{{ pub.cpt_pub.url }}\" target=\"blank\"><img src=\"{{ pub.cpt_pub.img }}\" title=\"{{ pub.cpt_pub.title }}\" /></a></div>
  {% set cpt = 0 %}
